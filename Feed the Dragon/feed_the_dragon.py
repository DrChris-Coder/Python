...
#Set fonts
font = pygame.font.Font("Feed the Dragon\\feed_the_dragon_assets\\AttackGraffiti.ttf")
...
coin_sound = pygame.mixer.Sound("Feed the Dragon\\feed_the_dragon_assets\\coin_sound.wav")
miss_sound = pygame.mixer.Sound("Feed the Dragon\\feed_the_dragon_assets\\miss_sound.wav")
miss_sound.set_volume(.1)
pygame.mixer_music.load("Feed the Dragon\\feed_the_dragon_assets\\ftd_background_music.wav")


#set images
player_image = pygame.image.load("Feed the Dragon\\feed_the_dragon_assets\\dragon_right.png")
player_rect = player_image.get_rect()
player_rect.left = 32
player_rect.centery = WINDOW_HEIGHT//2

coin_image = pygame.image.load("Feed the Dragon\\feed_the_dragon_assets\\coin.png")
