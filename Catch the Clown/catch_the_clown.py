...
#set fonts
font = pygame.font.Font("Catch the Clown\\catch_the_clown_assets\\Franxurter.ttf")
...
#set sound and music
hit_sound = pygame.mixer.Sound("Catch the Clown\\catch_the_clown_assets\\click_sound.wav")
miss_sound = pygame.mixer.Sound("Catch the Clown\\catch_the_clown_assets\\miss_sound.wav")
pygame.mixer.music.load("Catch the Clown\catch_the_clown_assets\ctc_background_music.wav")

#set images
background_image = pygame.image.load("Catch the Clown\\catch_the_clown_assets\\background.png")
background_rect = background_image.get_rect()
background_rect.topleft = (0,0)

clown_image = pygame.image.load("Catch the Clown\\catch_the_clown_assets\\clown.png")
